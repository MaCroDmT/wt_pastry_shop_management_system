    ...
    public function login($username, $password)
{
    ...
    //update user info
    public function updateProfile($user_id, $username, $c_pass, $c_c_pass, $email, $phone_number, $contact_method, $delivery_address, $permanent_address)
    {
        ...
        $stmt->bind_param("sssssssss", $username, $c_pass, $c_c_pass, $email, $phone_number, $contact_method, $delivery_address, $permanent_address, $user_id);
