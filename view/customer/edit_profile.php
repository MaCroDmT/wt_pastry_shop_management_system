...
<?php if(isset($success_message)) { echo "<p class='p'> $success_message</p>"; } ?>
...
<form method="POST" action="edit_profile.php">
   <table>
        ...
        <tr>
            <td class="text">Contact Method</td>
            <td class="text">:</td>
            <td><input type="text" name="c_contact_method" value="<?php echo $_SESSION['contact_method']; ?>"></td>
        </tr>
        <tr>
    ...
    <td>
        ...
        <tr>
            ...
            <td class="text">:</td>
            <td><input type="text" name="c_Delivery_address" value="<?php echo $_SESSION['delivery_address']; ?>"></td>
        </tr>
        <tr>
            <td class="text">Permanent Address</td>
            <td class="text">:</td>
            <td><input type="text" name="c_Parmanent_address" value="<?php echo $_SESSION['permanent_address']; ?>"></td>
